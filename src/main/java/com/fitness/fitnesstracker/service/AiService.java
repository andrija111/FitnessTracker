 ...
 * and previous workout progress entries.
 */
@Service
...
public class AiService {
     ...
     * Takes into account the user profile and previous progress entries.
     *
    ...
    public String generateWorkoutPlan(String email) {
        ...
        String progressSummary = workoutProgressService.getProgressSummaryForAi(user.getId());

        String prompt = buildPrompt(profile, progressSummary);
     ...
     * @param progressSummary summary of recent progress entries
     * @return formatted prompt string to send to the AI
     */
    private String buildPrompt(UserProfile profile, String progressSummary) {
        return String.format("""
                ...
                If the user mentioned exercises are too easy in their notes, increase intensity.
                If the user is showing good progress, make the plan more challenging.
